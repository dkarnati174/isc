...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
           ...
           alert("Welcome aboard! You account has been activated.");
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="<?php echo base_url("?c=iscreg&m=home")?>">Home <span class="sr-only">(current)</span></a></li>
...
<div class="container">
    ...
    <div class="row text-center pad-botom">
        <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 ">
            <h1>International Student Center</h1>
            <h5>
                we serve international students in Marist College and Poughkeepsie Town.
                We work to facilitate the success of our more than 1000 international students and scholars during their time in the United States.
            </h5>
        </div>
    </div>
    <div class="row text-center pad-botom">
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <h3>Forums</h3>
            <p>
                Looking for accommodation, basic need or any other help? Please post your need here!
            </p>
        </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <p>
                ...
                Let others know and make it possible.
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <h3>Events</h3>
            <p>
                Lets celebrate together. Connect with people and know cultures.
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <h3>Financing</h3>
            <p>
                As an international student, It is difficult to predict unexpected expenses when you are living away from home.
                Request a loan from your fellow students who are interested to invest in you.
            </p>
        </div>
    </div>
    <!-- ROW END -->
