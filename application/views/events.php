...
<div class="container">
    ...
    <div class="alert alert-warning">
        <h4>Alert</h4>
        <p>This feature is under maintenance. You may face some difficulties while accessing it.</p>
    </div>
            ...
            <table class="table table-condensed table-bordered">
                ...
                <tr>
                    <td class="agenda-date" class="active" rowspan="1">
                        ...
                        <div class="shortdate text-muted">September, 2016</div>
                    </td>
                    ...
                    <td class="agenda-events">
                        <div class="agenda-event">
                            <a href=""> Geraldine R. Dodge Poetry Festival </a>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="agenda-date" class="active" rowspan="1">
                        ...
                        <div class="dayofweek">Saturday</div>
                        <div class="shortdate text-muted">October, 2016</div>
                    </td>
                    <td class="agenda-time">
                        7:00 PM- 9:00 PM
                    </td>
                    <td class="agenda-events">
                        <div class="agenda-event">
                            <a href="">  Diwali- A festival of lights</a>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="agenda-date" class="active" rowspan="3">
                        ...
                        <div class="shortdate text-muted">December, 2016</div>
                    </td>
                    <td class="agenda-time">
                        7:00 - 9:00 PM
                    </td>
