...
<div id="main-container" class="container">
                    ...
                    <form class="form-horizontal" >
                        ...
                        <fieldset>
                            ...
                            <h4 style="text-align: center; margin: 30px; font-size: 40px;">Registration</h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="email" type="email" id="email" data-fv-emailaddress-message="The value is not a valid email address" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="city" type="city" id="city" class="form-control input-md" required="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="state" type="state" id="state" class="form-control input-md" required="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Country</label>
                                <div class="col-md-4">
                                    <input class="form-control" name="country" type="country" id="country" class="form-control input-md" required="" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="country" type="password" id="country" class="form-control input-md" required="" />
                                </div>
                            </div>
                            <div align="center" class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <button id="submit" name="submit" class="btn btn-primary" type="submit" style="background: #333;">Register</button>
                                </div>
                            </div>
...
<script type="text/javascript">
    $('button#submit').click(function(e) {
        ...
        $.ajax({
            ...
            type: "POST",
            url: "<?php echo base_url("?c=iscreg&m=register");?>",
            data: form_data,
            processData: false,
            contentType: false,
            cache: false,
            ...
            success: function (data) {
                if (data >0) {
                    ...
                    alert("You have registered successfully. You should receive a confirmation email shortly");

                } else {

                    alert("Failure: Something went wrong. Please try agian later");
